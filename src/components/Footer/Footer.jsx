      ...
      <div className={styles.inner + ' container'}>
        <div className={styles.col}>
          ...
          <div className={styles.socials}>
            <a href="https://www.facebook.com/pruthiraj.rout.921/" className={styles.socialLink} aria-label="Facebook">
            ...
            <a href="facebook.com/pruthiraj.rout.921" className={styles.socialLink} aria-label="Twitter">
            ...
            <a href="https://www.instagram.com/pruthi_0007?igsh=dXA1dnprc3ltNWtr" className={styles.socialLink} aria-label="Instagram">
